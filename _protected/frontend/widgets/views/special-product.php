			...
			if($product){
			 ...
			 <li>
				 <div class="sreen-gallery">
                            ...
                            <img src="<?= Yii::$app->params['baseurl'] ?>/uploads/product/main/<?= $product->id ?>/medium/<?= $product->productImages->main_image ?>" alt="complete-view" title="coplete-view" style="width:250px;height:250px;"></a>
