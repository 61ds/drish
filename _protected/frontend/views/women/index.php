            	...
            	<div class="row">
                	<div class="col-lg-12">
                    	<div class="woamn-stile">
						   <a href="<?= $banner11[2] ?>">
								<img src="<?= Yii::$app->params['baseurl'] . '/uploads/banner/large/'.$banner11[3]; ?>" alt="effortless" title="effortless" class="img-responsive">
							</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row">
                	<div class="col-lg-12">
                    	<div class="woamn-stile">
                        <a href="<?= $banner61[2] ?>">
                        <img src="<?= Yii::$app->params['baseurl'] . '/uploads/banner/large/'.$banner61[3]; ?>" alt="hope" title="hope" class="img-responsive">
                        </a>
